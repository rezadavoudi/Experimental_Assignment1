...
class CameraRotatingController:
    def __init__(self):
        rospy.init_node('rotating_controller')
        ...
        self.camera_holder_publisher = rospy.Publisher(
            '/robot4/camera_holder_position_controller/command', Float64, queue_size=1
        )
